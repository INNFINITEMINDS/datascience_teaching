...
Let's demonstrate one of the simplest examples of supervised learning: using linear regression to predict new values.
...
Use the lm() function to generate a linear model that predict y from x using the training set.

* Determine R^2 for the fitted model (at this point, use the training data to calculate this.). Does this model fit the data well?
